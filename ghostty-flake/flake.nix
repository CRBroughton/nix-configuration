{
  ...
  outputs = { self, nixpkgs, ghostty, nixgl, flake-utils }:
      ...
      let
        ...
        ghostty-wrapped = pkgs.stdenv.mkDerivation {
          ...
          installPhase = ''
            ...
            cp ${ghostty.packages.${system}.default}/share/icons/hicolor/128x128/apps/com.mitchellh.ghostty.png \
            ...
            cp ${ghostty.packages.${system}.default}/share/icons/hicolor/scalable/apps/com.mitchellh.ghostty.svg \
